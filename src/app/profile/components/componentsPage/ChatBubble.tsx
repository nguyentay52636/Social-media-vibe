...
export default function ChatBubble({ profileData, setShowImageSelector }: ChatBubbleProps) {
    return (
        <div className="fixed bottom-24 right-6 w-96 bg-background glass-effect border-white/20 rounded-xl shadow-lg z-50 p-6">
