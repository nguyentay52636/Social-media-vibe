...
import { ImageIcon, Paperclip, Send, Smile, Mic } from 'lucide-react'
...
export default function InputMessages({ newMessage, setNewMessage, handleSendMessage }: InputMessagesProps) {
    return (
        <>
